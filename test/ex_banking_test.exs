defmodule ExBankingTest do
  ...
  describe "&withdraw/1" do
    test "withdraw money correctly" do
      ExBanking.deposit("user2", 10, "usd")
      assert {:ok, _balance} = ExBanking.withdraw("user2", 5, "usd")
    end

    test "withdraw more money than the user actually have" do
  ...
  describe "&get_balance/1" do
    test "returns balance correctly" do
